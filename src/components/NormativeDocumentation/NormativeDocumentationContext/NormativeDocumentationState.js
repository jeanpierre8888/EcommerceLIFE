...
import { NormativeDocumentationContext } from "../NormativeDocumentationContext/NormativeDocumentationContext";
import { NormativeDocumentationReducer } from "../NormativeDocumentationContext/NormativeDocumentationReducer";
import { PERSONAL_INFO } from "./PersonalInformationReducer";
import { useMsal } from "@azure/msal-react";



const NormativeDocumentationState = (props) => {
    const { accounts } = useMsal();
    const initialState = {
        

    };
    const [state, dispatch] = useReducer(NormativeDocumentationReducer, initialState);
    ...
    return (
        <NormativeDocumentationContext.Provider
            value={{
...
export default NormativeDocumentationState;
